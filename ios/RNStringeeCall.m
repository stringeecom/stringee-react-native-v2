...
RCT_EXPORT_METHOD(clean : (NSString *)uuid) { RNStringeeInstanceManager.instance.callWrappers[uuid] = nil; }
...
RCT_EXPORT_METHOD(getCallStats : (NSString *)uuid callback : (RCTResponseSenderBlock)callback) {
    ...
    [call statsWithCompletionHandler:^(NSDictionary<NSString *, NSString *> *values) {
        NSData *jsonData = [NSJSONSerialization dataWithJSONObject:values options:NSJSONWritingPrettyPrinted error:nil];
