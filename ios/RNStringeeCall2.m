...
- (NSArray<NSString *> *)supportedEvents {
    return @[
        didChangeSignalingState, didChangeMediaState, didReceiveLocalStream, didReceiveRemoteStream, didReceiveDtmfDigit, didReceiveCallInfo,
        didHandleOnAnotherDevice, trackMediaStateChange, didAddLocalTrack, didAddRemoteTrack
    ];
}
...
RCT_EXPORT_METHOD(clean : (NSString *)uuid) { RNStringeeInstanceManager.instance.call2Wrappers[uuid] = nil; }
...
RCT_EXPORT_METHOD(setAutoSendTrackMediaStateChangeEvent
                  : (NSString *)uuid autoSendTrackMediaStateChangeEvent
                  : (BOOL)autoSendTrackMediaStateChangeEvent callback
