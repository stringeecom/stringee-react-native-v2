...
class StringeeClient {
  ...
  constructor(props: {
    ...
    // Gen UUID to create a unique identifier for this client instance and create a wrapper object in native code
    this.uuid = genUUID();
